package com.apparatus.retrosquash;
...
public class MainActivity extends Activity 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		try 
			...
			descriptor = assetManager.openFd("squash1.ogg");
			sample1 = soundPool.load(descriptor, 0); 
            descriptor = assetManager.openFd("squash2.ogg"); 
            sample2 = soundPool.load(descriptor, 0);
			descriptor = assetManager.openFd("squash3.ogg");
			sample3 = soundPool.load(descriptor, 0);
			descriptor = assetManager.openFd("squash4.ogg");
					...
					{ 
						...
						if (ballPosition.x + ballWidth > (racketPosition.x - halfRacket) && ballPosition.x - ballWidth < (racketPosition.x + halfRacket))
							{  
								...
								//now decide how to rebound the ball horizontall
